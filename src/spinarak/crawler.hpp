...
// 2019-10-31: Crawler no longer is a class, just a bundle of funtions in a namespace
//             moved Url class to its own file.
...
namespace dex
	...
	namespace crawler
		...
		int crawlUrl( Url url, int fileToWrite, string &res, dex::unorderedMap < string, RobotTxt > *robots )
			{
         RobotTxt robot;
